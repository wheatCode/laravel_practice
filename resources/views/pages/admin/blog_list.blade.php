...
<section class="body-content ">
    <div class="page-content">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <button type="button" class="btn btn-info" onclick="insertBlog()">新增＋</button>
                    <div class="list-group">
                        @forelse ($blogs as $blog)
                        <a href="/admin/blogs/{{$blog->id}}" class="list-group-item">{{$blog->title}}</a>    
                        <button type="button" class="btn btn-danger" style="margin-bottom:10px" onclick="destoryBlog({{$blog->id}})">刪除</button>
                        @empty
                        <p>No Blog</p>
                     @endforelse
